          ...
          <>
            ...
            {showPlayerList && (
		     ...
		     >
 		      ...
 		      {player.competitiveStartYear && (
 		        <span className="ml-2 text-sm text-gray-600">
 		          ({new Date().getFullYear() - player.competitiveStartYear} yrs)
 		        </span>
 		      )}
		     </li>
                  ))}
		      ...
		      <label>
		        ...
		        <input
		          ...
		          onChange={(e) =>
		            setEditedPlayer({
		              ...editedPlayer,
		              competitiveStartYear: parseInt(e.target.value) || '',
		            })
		          }
		          className="border px-3 py-2 rounded w-full"
...
{editedPlayer.competitiveStartYear && (
  <div className="text-sm text-gray-600">
    Years in Cricket: {new Date().getFullYear() - editedPlayer.competitiveStartYear}
  </div>
)}
                      <label>
                        Role
